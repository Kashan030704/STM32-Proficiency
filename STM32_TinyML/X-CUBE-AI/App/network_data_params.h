...
#define AI_NETWORK_DATA_ACTIVATIONS_SIZES \
  { 108, }
#define AI_NETWORK_DATA_ACTIVATIONS_SIZE     (108)
#define AI_NETWORK_DATA_ACTIVATIONS_COUNT    (1)
#define AI_NETWORK_DATA_ACTIVATION_1_SIZE    (108)



#define AI_NETWORK_DATA_WEIGHTS_SIZES \
  { 228, }
#define AI_NETWORK_DATA_WEIGHTS_SIZE         (228)
#define AI_NETWORK_DATA_WEIGHTS_COUNT        (1)
#define AI_NETWORK_DATA_WEIGHT_1_SIZE        (228)
